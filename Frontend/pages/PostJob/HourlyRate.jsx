  ...
  return (
    ...
    className='mt-[3rem]'>
      ...
      <div className='grid grid-cols-2 gap-[2rem]'>
       ...
       <h3 className='absolute ml-[72rem] mt-10 font-semibold text-2xl'>/ hour</h3>
       <h3 className='absolute ml-[32rem] mt-10 font-semibold text-2xl'>/ hour</h3>
